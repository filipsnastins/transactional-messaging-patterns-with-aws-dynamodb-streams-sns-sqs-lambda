...
** link:library-transactional-outbox[library-transactional-outbox] - Transactional Messaging patterns implementation
...
** link:terraform-transactional-outbox[terraform-transactional-outbox] - example Terraform module for
