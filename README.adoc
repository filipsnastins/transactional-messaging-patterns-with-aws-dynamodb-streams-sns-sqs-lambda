...
Notice that the responsibility of handling duplicate messages is now always on the consumer side,
...
Note that DynamoDB Streams also guarantee at-least-once delivery of events,
