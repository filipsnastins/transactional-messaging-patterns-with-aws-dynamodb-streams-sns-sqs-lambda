...
def _environment(monkeypatch: pytest.MonkeyPatch, moto_container: MotoContainer) -> None:
    ...
    monkeypatch.setenv("DYNAMODB_ORDERS_TABLE_NAME", "orders")
    monkeypatch.setenv("DYNAMODB_INBOX_TABLE_NAME", "orders-inbox")
    monkeypatch.setenv("DYNAMODB_OUTBOX_TABLE_NAME", "orders-outbox")
