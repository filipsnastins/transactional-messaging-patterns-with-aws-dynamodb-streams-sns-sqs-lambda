...
resource "aws_ecs_service" "default" {
  ...
  task_definition = var.revision == null ? aws_ecs_task_definition.default.arn_without_revision : "${aws_ecs_task_definition.default.arn_without_revision}:${var.revision}"
  launch_type     = "FARGATE"
